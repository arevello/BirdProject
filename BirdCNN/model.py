...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            #k_constants = K.variable(anchors, name="anchors")
            #anchors = k_constants(input_image)
            
            #my "fix"
            '''sl = ScaleLayer(anchors)
            
            #anchors = KL.Lambda(lambda x: sl.call(), name="anchors")(input_image)
            #anchors = sl()(input_image)
            anchor_layer = AnchorsLayer(name="anchors")
            anchors = anchor_layer(anchors)'''
            
            #print( anchors2.shape, input_image.shape)
            #anchors = (anchors2)*(input_image)
            #anchors = (anchors2)(input_image)
        else:
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        try:
            from keras.models import saving
        except ImportError:
    ...
    def compile(self, learning_rate, momentum):
        ...
        self.keras_model._losses = [] #unhashable type error
