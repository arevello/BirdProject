...
#COCO_WEIGHTS_PATH = os.path.join('C:\Users\Alex\eclipse-workspace', "mask_rcnn_coco.h5")
COCO_WEIGHTS_PATH = 'C:/Users/Alex/eclipse-workspace/mask_rcnn_coco.h5'
...
category = 'BIRD'
#class_names = ['HERG','GBBG','COEI_M','COEI_F','TERN','DCCO','CANG','GBHE','LAGU']
class_names = ['HERG']
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        coco = COCO(os.path.join(dataset_dir, 'via_region_data.json'))
